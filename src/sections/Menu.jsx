...
const Menu = () => {
    return (
        <section id="menu" className="py-32 bg-[#FDFCF8] relative overflow-hidden">
            ...
            {/* Background Texture/Gradient for warmth */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <motion.p
                        ...
                        className="text-stone-600 text-xl md:text-2xl font-light leading-relaxed mb-20 max-w-3xl mx-auto"
                    >
                    ...
                    >
                        <Magnetic>
                            ...
                            >
                                <span className="uppercase tracking-widest text-sm font-medium">Consulter le Menu</span>
