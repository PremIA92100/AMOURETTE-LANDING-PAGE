...
const menuData: Record<string, MenuItem[]> = {
  ...
  entrees: [
    ...
    { name: 'Thon epice, guacamole avocat', price: '23,00 EUR', image: '/images/amourette-640403.jpg' },
  ...
  plats: [
    ...
    { name: 'Risotto cremeux, gambas plancha', price: '38,00 EUR', image: '/images/amourette-640420.jpg' },
    { name: 'Noix de Saint-Jacques juste snackees', price: '38,00 EUR', image: '/images/amourette-640433.jpg' },
    { name: 'Saumon laque miso, gingembre, coriandre', price: '32,00 EUR', image: '/images/amourette-640416.jpg' },
    ...
    { name: 'Entrecote argentine bearnaise', price: '47,00 EUR', image: '/images/amourette-640414.jpg' },
  ],
  desserts: [
    ...
    { name: 'Petit pot de glace et sorbet, Philippe Faur maitre glacier', price: '8,00 EUR' },
